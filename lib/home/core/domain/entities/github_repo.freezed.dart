...
abstract class $GithubRepoCopyWith<$Res> {
  ...
  $Res call(
      {User owner, String repoName, String description, int stargazersCount});
...
class _$_GithubRepo extends _GithubRepo {
  ...
  @override
  String toString() {
    return 'GithubRepo(owner: $owner, repoName: $repoName, description: $description, stargazersCount: $stargazersCount)';
  }
