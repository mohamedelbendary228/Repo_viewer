...
import 'package:reop_viewer/core/presentation/toasts.dart';
import 'package:reop_viewer/github/core/presentation/no_results_display.dart';
import 'package:reop_viewer/github/repos/core/application/paginated_repos_notifier.dart';
import 'package:reop_viewer/github/repos/core/presentation/failure_repo_tile.dart';
import 'package:reop_viewer/github/repos/core/presentation/loading_repo_tile.dart';
import 'package:reop_viewer/github/repos/core/presentation/repo_tile.dart';
  ...
  Widget build(BuildContext context) {
    return Consumer(
      builder: (context, ref, child) {
        ...
        //   (state) {},
        // );
        final state = ref.call(widget.paginatedReposNotifierProvider);
